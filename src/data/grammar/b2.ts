...
export const B2_GRAMMAR: GrammarTopic[] = [
  ...
  {
    id: "gr_b2_phrasal_verbs",
    level: "b2",
    title: "Phrasal Verbs",
    title_vi: "Cụm động từ",
    summary_vi:
      "Cụm động từ = động từ + giới từ/trạng từ, tạo thành nghĩa mới khác hẳn nghĩa gốc. Ví dụ: give up = từ bỏ, look after = chăm sóc. Một số tách được (separable), một số không tách được (inseparable).",
    sections: [
      {
        heading: "Cụm động từ là gì?",
        points: [
          "Phrasal verb = động từ + particle (giới từ/trạng từ): turn on, give up, look after, take off.",
          "Nghĩa thường KHÁC HẲN nghĩa gốc của từng từ riêng lẻ: look up ≠ nhìn lên, mà = tra cứu.",
          "Rất phổ biến trong giao tiếp hàng ngày.",
        ],
      },
      {
        heading: "Tách được (Separable) vs Không tách được (Inseparable)",
        points: [
          "Tách được: có thể đặt tân ngữ xen giữa — Turn on the light. = Turn the light on. = Turn it on.",
          "💡 Nếu tân ngữ là đại từ (it, them, him, her...), BẮT BUỘC tách: Turn it on. (KHÔNG nói Turn on it).",
          "Không tách được: tân ngữ luôn đứng SAU particle — She looks after her mother. (KHÔNG nói looks her mother after).",
        ],
      },
      {
        heading: "Các cụm động từ phổ biến",
        points: [
          "turn on / turn off = bật / tắt: Turn on the TV.",
          "give up = từ bỏ: He gave up smoking.",
          "look after = chăm sóc: She looks after her children.",
          "pick up = nhặt lên / đón: Pick up the phone. / I'll pick you up at 5.",
          "put on / take off = mặc vào / cởi ra: Put on your coat. / Take off your shoes.",
          "find out = phát hiện, tìm ra: I found out the truth.",
          "look for = tìm kiếm: I'm looking for my keys.",
          "run out of = hết, cạn: We ran out of milk.",
          "get along with = hòa hợp với: She gets along with everyone.",
          "come up with = nghĩ ra: He came up with a great idea.",
        ],
      },
    ],
    points: [
      "Phrasal verb = động từ + particle: turn on, give up, look after.",
      "Nghĩa thường khác hẳn nghĩa gốc: look up = tra cứu (không phải nhìn lên).",
      "Tách được: Turn the light on. / Turn it on. (đại từ BẮT BUỘC tách).",
      "Không tách được: look after her. (KHÔNG nói look her after).",
    ],
    exercises: [
      {
        id: "e1",
        ...
        options: ["turn on", "turn up to", "turn in"],
        answer: "turn on",
        explain_vi: "turn on = bật (thiết bị điện): bật TV.",
      },
      {
        id: "e2",
        type: "fill",
        question: "She decided to ___ ___ smoking. (từ bỏ)",
        answer: "give up",
        explain_vi: "give up = từ bỏ: give up smoking = bỏ hút thuốc.",
      },
      {
        id: "e3",
        type: "choice",
        question: "Who ___ the children while you're at work?",
        options: ["looks after", "looks up", "looks for"],
        answer: "looks after",
        explain_vi: "look after = chăm sóc: looks after the children.",
      },
      {
        id: "e4",
        type: "choice",
        question: "I need to ___ my keys. I can't find them anywhere.",
        options: ["look for", "look after", "look up"],
        answer: "look for",
        explain_vi: "look for = tìm kiếm: look for my keys.",
      },
      {
        id: "e5",
        type: "fill",
        question: "It's cold. ___ ___ your jacket. (mặc vào)",
        answer: "Put on",
        explain_vi: "put on = mặc vào: Put on your jacket.",
      },
      {
        id: "e6",
        type: "choice",
        question: "Please ___ your shoes before entering the house.",
        options: ["take off", "take on", "take up"],
        answer: "take off",
        explain_vi: "take off = cởi ra: take off your shoes.",
      },
      {
        id: "e7",
        type: "choice",
        question: "The light is on. Can you turn ___ off?",
        options: ["it", "on it", "off it"],
        answer: "it",
        explain_vi: "Đại từ (it) bắt buộc đặt giữa: turn it off. Không nói turn off it.",
      },
      {
        id: "e8",
        type: "fill",
        question: "We've ___ ___ of milk. Can you buy some? (hết)",
        answer: "run out",
        explain_vi: "run out of = hết, cạn: We've run out of milk.",
      },
      {
        id: "e9",
        type: "reorder",
        question: "Sắp xếp: Cô ấy nghĩ ra một ý tưởng tuyệt vời.",
        options: ["She", "came up with", "a great idea"],
        answer: "She came up with a great idea",
        explain_vi: "come up with = nghĩ ra (không tách được).",
      },
      {
        id: "e10",
        type: "choice",
        question: "I finally ___ the answer to the puzzle.",
        options: ["found out", "found up", "found in"],
        answer: "found out",
        explain_vi: "find out = phát hiện, tìm ra: found out the answer.",
      },
      {
        id: "e11",
        type: "fill",
        question: "She ___ along well ___ her colleagues. (hòa hợp với)",
        answer: "gets / with",
        explain_vi: "get along with = hòa hợp với: gets along with her colleagues.",
      },
      {
        id: "e12",
        type: "reorder",
        question: "Sắp xếp: Tôi sẽ đón bạn lúc 6 giờ.",
        options: ["I'll", "pick", "you", "up", "at 6"],
        answer: "I'll pick you up at 6",
        explain_vi: "pick up = đón ai. Tân ngữ là đại từ (you) nên tách: pick you up.",
      },
    ],
  },
  {
